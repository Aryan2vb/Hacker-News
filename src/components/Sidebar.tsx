...
export default function Sidebar() {
  ...
  return (
      <aside
          className="w-64 h-screen bg-gray-300 dark:bg-gray-950 dark:text-gray-300 text-navy p-4 flex flex-col border-r border-gray-800 hidden md:flex">
        <div className="flex items-center gap-3 mb-8">
          <div className="w-8 h-8 bg-orange-500 rounded-md flex items-center justify-center text-white font-bold">
            Y
          </div>
          <span className="text-xl font-semibold  dark:text-white text-navy">Hacker News</span>
        </div>
